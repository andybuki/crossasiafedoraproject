...
public class DllmFedoraManifest {
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException , IOException {
        File absolutePath_Books = new File("/data1/dllm/manifest/books/");

        String quote = "\u005c\u0022";
        String encoding = "UTF-8";


            File dir_books = new File(String.valueOf(absolutePath_Books));
            File[] filesInDir_Books = dir_books.listFiles();


            for (File file : filesInDir_Books) {
            ...
            if (lizenz != "")
               ...
               /* sb.append(quote + "dc:source" + quote + ":" + quote + "Digital Library of Lao Manuscripts" + quote + "," + '\n');
                ...
                PrintStream out = new PrintStream(new FileOutputStream("/data1/dllm/books_pages/"+id+".json"));
