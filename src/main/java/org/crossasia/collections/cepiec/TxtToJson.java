...
public class TxtToJson {
    public static void main(String[] args) throws IOException {
        ...
        PrintStream out = new PrintStream(new FileOutputStream("/data/solr/cepiec_new.json"));
        String id ="";
        ...
        for (File file : dir.listFiles()) {
            ...
            while (line != null) {
                ...
                if (line!=null) {
                    ...
                    sb.append(quote + "title" + quote + ":" + quote + title.replaceFirst("　 ","").replaceFirst("　","") + quote + "," + '\n');
                    sb.append(quote + "text" + quote + ":" + quote + text.replaceFirst("　 ","").replace("\""," ") + quote + "," + '\n');
