...
public class ConvertXmlToJsonPage {
    public static void main( String[] args ) throws Exception {
        ...
        PrintStream out = new PrintStream(new FileOutputStream("D:\\RAW-COLLECTIONS\\ChinaTrade&Politics\\pages.json"));
        String bookName = "";
        String page = "";
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                if (image instanceof JSONObject) {
                    ...
                    out.println("{"
                            + quote + "id" + quote + ":" + quote+ id+"page_"+imageUrl.replace("http://www.china.amdigital.co.uk/Documents/Images/", "").split("/")[0].replaceAll("%20","_") + quote + "," + '\n'
                            ...
                            + quote + "book_id" + quote + ":" + quote+ imageUrl.replace("http://www.china.amdigital.co.uk/Documents/Images/", "").split("/")[0].replaceAll("%20","_") + quote + "," + '\n'
                ...
                //String id = (String) image.get( "id" ).toString();
                //String imageUrl = (String) image.get( "imageUrl" ).toString();
                //String imageFile = (String) image.get( "imageFile" ).toString();
