package org.crossasia.collections.cnki;
...
public class CNKIFedoraBook {
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        File dir = new File("/data1/fedora/ajax-cnki/pages2");
        String quote = "\u005c\u0022";
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                String solr = "http://b-app69:8995/solr/ajax-cnki/select?q=id:" + id;
