...
public class ConferenceAddName {

    public static void main(String[] args) {
        try {
            String quote = "\u005c\u0022";
            JSONObject jsonObject;
            String thesis = "D:\\SOLR-COLLECTIONS\\Conference2.json";
            String thesis_name = "D:\\SOLR-COLLECTIONS\\Conference_Name.json";
            PrintStream out = new PrintStream(new FileOutputStream("D:\\SOLR-COLLECTIONS\\Conference_Result.json"));
