...
public class ConvertXmlToJsonBook3 {
    public static void main( String[] args ) throws Exception {

        File dir = new File("D:\\SOLR-COLLECTIONS\\1\\");
        PrintStream out = new PrintStream(new FileOutputStream("D:\\SOLR-COLLECTIONS\\journalsArticle4.json"));
        String bookName = "";
        String page = "";
        String text = "";
        String quote = "\u005c\u0022";
