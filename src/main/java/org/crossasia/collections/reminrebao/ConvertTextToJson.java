...
public class ConvertTextToJson {
    public static void main( String[] args ) throws Exception {
        ...
        PrintStream out = new PrintStream(new FileOutputStream("D:\\REMIN REBAO\\rem_2007_2009.json"));
        String bookName = "";
        String page = "";
        String text = "";
        String quote = "\u005c\u0022";
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                out.println("{" + quote + "id" + quote + ":" + quote + fileName2+"_rmrb" + quote + "," + '\n'
                        ...
                        + quote + "date" + quote + ":" + year + "," + '\n'
                        + quote + "hasModel" + quote + ":" +   quote +"Article" +  quote + "," + '\n'
                        + quote + "wholeDate" + quote + ":" + wholeDate + "," + '\n'
