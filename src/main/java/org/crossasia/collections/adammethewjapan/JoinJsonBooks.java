...
public class JoinJsonBooks {

    public static void main(String[] args) {
        try {
            String quote = "\u005c\u0022";
            JSONObject jsonObject;
            String books = "D:\\SOLR-COLLECTIONS\\ajax-riben\\books.json";
            PrintStream out = new PrintStream(new FileOutputStream("D:\\SOLR-COLLECTIONS\\ajax-riben\\books_new2.json"));
            ...
            for (int i=0; i<bookObject.length(); i++) {
                ...
                if (numerObj.has("creator"))
                creator = (String) numerObj.get("creator").toString();
                ...
                if (!ident1.contains("http://hunteq.com/ancientc/ancientkm?!!")){
                    book_id = ident1;
                } else if (!ident2.contains("http://hunteq.com/ancientc/ancientkm?!!")) {
                    book_id = ident2;
                }
                if (numerObj.has("temporal"))
                temporal = (String) numerObj.get("temporal").toString();
                if (numerObj.has("issued"))
                ...
                out.println("{" + quote + "id" + quote + ":" + quote+ id+ quote + "," + '\n'
                                ...
                                + quote + "collection" + quote + ":" + quote+ "AAAAAA"+ quote + "," + '\n'
