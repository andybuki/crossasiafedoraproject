...
public class ConvertJsonToJsonBooks {
    ...
    public static void main(String[] args) throws Exception{
        ...
        File dir = new File("D:\\SOLR-COLLECTIONS\\AMD-JAPAN\\books\\");
        PrintStream out = new PrintStream(new FileOutputStream("D:\\SOLR-COLLECTIONS\\AMD-JAPAN\\books3.json"));
        String bookName = "";
        String page = "";
        String text = "";
        String quote = "\u005c\u0022";
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                for (int k=0; k<object.size();k++) {
                    ...
                    String publication_name = (String) book.get("publication_name").toString();
                    String edition = (String) book.get("edition").toString();
                    String description = (String) book.get("description").toString();
                    String medium = (String) book.get("medium").toString();
                    String subject = (String) book.get("subject").toString();
                    String organization = (String) book.get("organization");
                    String keywords = (String) book.get("keywords").toString();
                    String source = (String) book.get("source").toString();
                    String spatial = (String) book.get("spatial").toString();
                    String person = (String) book.get("person").toString();
