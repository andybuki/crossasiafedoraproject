...
public class TxtToJson {
    public static void main(String[] args) throws IOException {
        File dir = new File("\\pk.de\\sbb\\Dev-Transfer\\民国图书数据库全文元数据\\TXT\\");
        ...
        String column= "";
        String textChina= "";
        File file2 = new File("\\pk.de\\sbb\\Dev-Transfer\\民国图书数据库全文元数据\\TXT");
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                String fileName1 = fileName.replace("\\pk.de\\sbb\\Dev-Transfer\\民国图书数据库全文元数据\\TXT\\", "");
