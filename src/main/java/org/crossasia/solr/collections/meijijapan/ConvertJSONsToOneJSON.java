...
public class ConvertJSONsToOneJSON {
    public static void main(String[] args) throws FileNotFoundException {

        String filePathFolder = "/data1/solr/MeijiJapan/meta/";
        String directoryPath = "/data1/solr/MeijiJapan/meta/";
        String quote = "\u005c\u0022";
        PrintStream out = new PrintStream(new FileOutputStream("/data1/solr/MeijiJapan/books.json"));
        ...
        for (File path : paths) {
            ...
            String issued = "";
            String nodeId = "";
            String erflink="http://erf.sbb.spk-berlin.de/han/airiti/";
            //String series_title = "";
            ...
            for (int i=0; i<booksArrays.length(); i++){
                ...
                if (booksObject.has("spatial")) {
                    spatial  = (String) booksObject.get("spatial");
                }
                ...
                sb.append(  quote + "collection" + quote + ":" + quote+ "Adam Matthew - Meiji Japan"+ quote + "," + '\n' );
