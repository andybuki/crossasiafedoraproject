package org.crossasia.fedora.ccg;
...
public class CCGFedoraBook {
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        File dir = new File("/data1/fedora/ajax-eastview-ccg/page2");
        String quote = "\u005c\u0022";
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                if (booksObj.has("id")) {
                    id2 = (String) booksObj.get("id").toString();
                }
                ...
                if (booksObj.has("dcterms:bibliographicCitation")) {
                    bibliographicCitation = (String) booksObj.get("dcterms:bibliographicCitation").toString();
                }
                ...
                if (booksObj.has("schema:volumeNumber")) {
                    volumeNumber = (String) booksObj.get("schema:volumeNumber").toString();
                }
                ...
                if (booksObj.has("schema:chapter")) {
                    chapter = (String) booksObj.get("schema:chapter").toString();
                }
                ...
                if (booksObj.has("crossasia:running_title")) {
                    running_title = (String) booksObj.get("crossasia:running_title").toString();
                }

                if (booksObj.has("dcterms:format")) {
                    formatDC = (String) booksObj.get("dcterms:format").toString();
                }
                ...
                if (booksObj.has("schema:url")) {
                    urlFull = (JSONArray) booksObj.get("schema:url");
                ...
                if (booksObj.has("dcterms:identifier")) {
                    id = (String) booksObj.get("dcterms:identifier");
                }
                ...
                if (booksObj.has("dc:title")) {
                    title = (String) booksObj.get("dc:title");
                }
                ...
                if (booksObj.has("dc:edition")) {
                    try {
                        edition = (String) booksObj.get("dc:edition");
                ...
                if (booksObj.has("dcterms:spatial")) {
                    spatial = (String) booksObj.get("dcterms:spatial");
                }
                ...
                String solr = "http://b-app69:8995/solr/ajax-eastview-ccg/select?q=id:" + id;
                ...
                if (chapter != "")
                    sb.append(quote + "schema:Chapter" + quote + ":" + quote + chapter + quote + "," + '\n');
                ...
                if (running_title != "")
                    sb.append(quote + "crossasia:running_title" + quote + ":" + quote + running_title + quote + "," + '\n');
                ...
                if (volumeNumber != "") {
                    sb.append(quote + "schema:volumeNumber" + quote + ":" + quote + volumeNumber + quote + "," + '\n');
                }

                if (article_id != "") {
                    sb.append(quote + "schema:identifier" + quote + ":" + quote + id2 + quote + "," + '\n');
                }
                ...
                if (formatDC != "") {
                    sb.append(quote + "dcterms:format" + quote + ":" + quote + formatDC + quote + "," + '\n');
                }
