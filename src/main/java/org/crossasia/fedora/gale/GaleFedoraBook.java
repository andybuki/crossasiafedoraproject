package org.crossasia.fedora.gale;
...
public class GaleFedoraBook {
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        File dir = new File("/data1/fedora/ajax-gale-cfer/article2");
        String quote = "\u005c\u0022";
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                if (booksObj.has("dc:medium")) {
                    medium = (String) booksObj.get("dc:medium");
                }
                ...
                String solr = "http://b-app69:8995/solr/ajax-gale-cfer/select?q=id:" + id;
                ...
                if (medium != "")
                    sb.append(quote + "dcterms:medium" + quote + ":" + quote+medium + quote+"," + '\n');
