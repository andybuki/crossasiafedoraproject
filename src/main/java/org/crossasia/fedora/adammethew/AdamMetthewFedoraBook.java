package org.crossasia.fedora.adammethew;
...
public class AdamMetthewFedoraBook {
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        File dir = new File("/data1/fedora/ad_NEW/pages/");
        String quote = "\u005c\u0022";
        ...
        for (File file : dir.listFiles()) {
            ...
            try {
                ...
                if (booksObj.has("dcterms:identifier")) {
                    identifier = (String) booksObj.get("dcterms:identifier");
                }

                //type = (String) booksObj.get("pcdm:Object").toString();

                String solr = "http://b-app69:8995/solr/ajax-amd/select?q=id:" + id;
                ...
                if (rightsHolder != "")
                    sb.append(quote + "dcterms:rightsHolder" + quote + ":" + quote + rightsHolder + quote + "," + '\n');
                ...
                if (identifier != "")
                    sb.append(quote + "uri" + quote + ":" + quote + identifier + quote + "" + '\n');
