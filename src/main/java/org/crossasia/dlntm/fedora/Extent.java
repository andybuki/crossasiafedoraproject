...
public class Extent {
    public static StringBuilder addExtent() throws FileNotFoundException {
        ...
        if (number_of_fascicles!=0 || number_of_digital_images!=0) {
            extentBuilder.append(QUOTE + "dcterms:extent" + QUOTE + ":" + QUOTE+ number_of_fascicles + " fascicle(s), " + number_of_digital_images+" (img.)"+QUOTE+"," + '\n');
